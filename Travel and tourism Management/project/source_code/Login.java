...
public class Login extends JFrame{
    ...
    Login() {
        ...
        lblusername.setBounds(60, 20, 100, 25);
                  //position: (left, up, down, right);
        lblusername.setFont(new Font("RABBI HASAN", Font.PLAIN, 20));
        p2.add(lblusername);
        ...
        lblpassword.setFont(new Font("RABBI HASAN", Font.PLAIN, 20));
        p2.add(lblpassword);
